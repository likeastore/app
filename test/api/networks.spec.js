			...
			describe('for tumblr', function () {
				...
				describe('post', function () {
					...
					describe('request token', function () {
						...
						it ('should requestToken be saved to user record', function () {
							expect(userFromDb.tumblrRequestToken).to.be.ok;
						});

						it ('should requestToken secret be saved to user record', function () {
							expect(userFromDb.tumblrRequestTokenSecret).to.be.ok;
						});
					});
				});
			});
			...
			describe('for flickr', function () {
				...
				describe('post', function () {
					...
					describe('request token', function () {
						...
						it ('should requestToken be saved to user record', function () {
							expect(userFromDb.flickrRequestToken).to.be.ok;
						});

						it ('should requestToken secret be saved to user record', function () {
							expect(userFromDb.flickrRequestTokenSecret).to.be.ok;
						});
					});
				});
			});
